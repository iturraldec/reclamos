...
return [
    ...
    */
    ...
    'title' => '',
    'title_prefix' => 'Clínica de Especialidades Médicas | ',
    'title_postfix' => '',
    ...
    */
    ...
    'use_route_url' => false,
    'dashboard_url' => 'admin/reclamos/dashboard',
    'logout_url' => 'logout',
    'login_url' => 'login',
    'register_url' => '',
    'password_reset_url' => '',
        ...
        ['header' => 'MENÚ DEL ADMINISTRADOR'],
		  [
			...
			'submenu' => [
				 ...
				 [
					'text' => 'Derechos en Salud',
					'url'  => '/admin/paciente/derechos',
			  	 ],
				 [
					  'text' => 'Causas',
					  'url'  => '/admin/causas',
		...
		'DateTimePicker' => [
			...
			'files' => [
				 [
					'type' => 'js',
					'asset' => true,
					'location' => 'vendor/jquery-datetimepicker/js/datetimepicker.full.min.js',
				 ],
				 [
					'type' => 'css',
					'asset' => true,
					'location' => 'vendor/jquery-datetimepicker/css/datetimepicker.min.css',
				 ],
			],
		  ],
        'Datatables' => [
